...
const Loader = (props) => {
    ...
    const loaderClassNames = `${styles.loaderOverlay} ${props.isshown ? styles.loaderShow : styles.loaderHide}`
        ...
        ReactDOM.createPortal(
            <React.Fragment>
                <div className={loaderClassNames}>
                    <LoaderContainer>
                        <div>
                            <svg width={width} height={height} viewBox="0 0 700 704" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="stopwatch">
